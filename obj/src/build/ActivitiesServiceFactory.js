...
class ActivitiesServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
ActivitiesServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "factory", "default", "default", "1.0");
ActivitiesServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "persistence", "memory", "*", "1.0");
ActivitiesServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "persistence", "file", "*", "1.0");
ActivitiesServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "persistence", "mongodb", "*", "1.0");
ActivitiesServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "controller", "default", "*", "1.0");
ActivitiesServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "service", "seneca", "*", "1.0");
ActivitiesServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-activities", "service", "http", "*", "1.0");
